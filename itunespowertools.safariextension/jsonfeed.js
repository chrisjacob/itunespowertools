// source: http://itunes.apple.com/static/rssgenerator/jsonfeed.js
...
function buildFeedList(type) {
    var list = eval(type);
    var output = "";
    for (var i=0; i < list.length; i++) {
        output += "<li>" + (i+1) + ". <a href=\"javascript:void(0);\" onclick=\"populateFromLink(\'" + type + "\'," + i + ");\">" + list[i][0] + "</a></li>\n";
    }
    $('feedList').innerHTML = output;
}